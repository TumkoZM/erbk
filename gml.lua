...
*************************************************
Edited by Doob
Added real clipboard and correct centering
*************************************************
Added 
]]
...
local function parsePosition(x,y,width,height,maxWidth,maxHeight)
  ...
  elseif x=="center" then
    x=math.max(1,math.floor((maxWidth-width)/2))+1
  end
  if x<0 then
  ...
  elseif y=="center" then
    y=math.max(1,math.floor((maxHeight-height)/2))+1
  end
  if y<0 then
...
local function runGui(gui)
  ...
  while true do
    ...
    elseif e[1]=="clipboard" then
      if gui.focusElement.doPaste and e[3] then
        gui.focusElement:doPaste(e[3])
      end
